...
<main>
    <div
        class="left"
        style="background-image: linear-gradient( rgba(var(--midnight), 0.7), rgba(var(--midnight), 0.7) ), url('{base}/{storymapId}.jpg');"
    >
        <div class="bg" />
        <div class="logo">
            <img
        ...
        <div class="btn-box">
            ...
            <div class="mini-btn-box">
                <a
                    class="lang-btn"
                    href="{base}/es/{$page.params.id}"
                    style="background: #{storymapContent.color};"
                    >{content.es}</a
                >
                <a
                    class="lang-btn"
                    href="{base}/{$page.params.id}"
                    style="background: #{storymapContent.color};"
                    >{content.en}</a
                >
            </div>
