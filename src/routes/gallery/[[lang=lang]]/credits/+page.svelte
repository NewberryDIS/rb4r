...
<div class="bg-1-image" style="background-image: url('{base}/maps/{bg}')" />
<div class="bg-2-wedge" />
<main class={bgc ? "bgl" : "bgd"}>
    <section class="top-level-wrapper main">
        <div class="link-block">
            <a class="arrow-link" href="{base}/gallery/{lang === 'es' ? 'es' : ''}"
                ><img width="50" height="50" src="{base}/arrow.png" alt="" /></a
            >
            <p>
                <a
                    href="{base}/gallery/credits"
                    class="lang-link {lang !== 'es' ? 'active' : ''}">en</a
                ><a
                    href="{base}/gallery/es/credits"
                    class="lang-link {lang === 'es' ? 'active' : ''}">es</a
                >
            </p>
        </div>
        <article>
            ...
            <section>
                <p>{@html content[lang].credits.toptext}</p>
            </section>
            <section>
                <dl>
                    <dt>{content[lang].credits.dl[0]}</dt>
                    <dd>
                        Noémie Ndiaye, Lia Markey, Christopher Fletcher, Rebecca
                        L. Fall, Yasmine Hachimi
                    </dd>

                    <dt>{content[lang].credits.dl[1]}</dt>
                    <dd>
                        Barbara Korbel, Kimberly Nichols, Gabriel Hamer, Leith
                        Calcote
                    </dd>
                    ...
                    <dd>
                        Chris Cermak, Pete Diernberger, Mike Mitchell, Jason
                        Ulane
                    </dd>
                </dl>
...
<style>
    ...
    .bgl .top-level-wrapper {
        box-shadow: 0 0 8px 8px rgba(var(--midnight), 0.1);
        background: rgba(var(--granite), 0.7);
    }
    .bgd {
    ...
    .bgd .top-level-wrapper {
        box-shadow: inset 0 0 8px 8px rgba(var(--midnight), 0.1);
