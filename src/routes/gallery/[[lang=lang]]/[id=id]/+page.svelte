...
<main >
    <div class="left" style="background-image: linear-gradient( rgba(var(--fg-color-1), 0.7), rgba(var(--fg-color-1), 0.7) ), url('{base}/{storymapId}.jpg');" >
        ...
        <div class="btn-box"> 
            <a class="home-btn" href="{base}/gallery/{$page.params.lang || ''}" style="background: #{storymapContent.color};">{lang === 'en' ? "Choose another object": "Elige otro objeto"}</a>
            <div class="mini-btn-box">
                <a class="lang-btn" href="{base}/gallery/es/{$page.params.id}" style="background: #{storymapContent.color};">{content.es}</a>
                <a class="lang-btn" href="{base}/gallery/{$page.params.id}" style="background: #{storymapContent.color};">{content.en}</a>
        ...
        <div class="right">
            <iframe src="https://digital.newberry.org/storymaps/gallery/{lang}/{ $page.params.id }" frameborder="0" title="storymap i-frame"></iframe>
